...
CREATE TABLE SpotifyClone.usuario_tabela(
    ...
    FOREIGN KEY (plano_id) REFERENCES SpotifyClone.plano_tabela(plano_id)
);

CREATE TABLE SpotifyClone.seguindo_artistas_tabela(
    usuario_id INT NOT NULL,
    artista_id INT NOT NULL,
    PRIMARY KEY (usuario_id, artista_id),
    FOREIGN KEY (usuario_id) REFERENCES SpotifyClone.usuario_tabela(usuario_id),
    FOREIGN KEY (artista_id) REFERENCES SpotifyClone.artista_tabela(artista_id)
);
...
CREATE TABLE SpotifyClone.cancoes_tabela(
    ...
    FOREIGN KEY (album_id) REFERENCES SpotifyClone.album_tabela(album_id)
);

CREATE TABLE SpotifyClone.reproducoes_historico_tabela(
    usuario_id INT NOT NULL,
    cancao_id INT NOT NULL,
    data_play DATETIME NOT NULL,
    PRIMARY KEY (usuario_id, cancao_id),
    FOREIGN KEY (usuario_id) REFERENCES SpotifyClone.usuario_tabela(usuario_id),
    FOREIGN KEY (cancao_id) REFERENCES SpotifyClone.cancoes_tabela(cancao_id)
);

INSERT INTO SpotifyClone.artista_tabela(artista_id, artista)
VALUES
    (1, 'Walter Phoenix'),
    (2, 'Peter Strong'),
    (3, 'Lance Day'),
...
INSERT INTO SpotifyClone.plano_tabela(plano_id, plano, valor_plano)
VALUES
    (1, 'gratuito', 0.00),
    (2, 'familiar', 7.99),
...
INSERT INTO SpotifyClone.usuario_tabela(usuario_id, plano_id, usuario, idade, data_assinatura)
VALUES
...
INSERT INTO SpotifyClone.seguindo_artistas_tabela(usuario_id, artista_id)
VALUES
    (1, 1),
    (1, 4),
    (1, 3),
...
INSERT INTO SpotifyClone.album_tabela(album_id, artista_id, album, ano_lancamento)
VALUES
    (1, 1, 'Envious', 1990),
    (2, 1, 'Exuberant', 1993),
...
INSERT INTO SpotifyClone.cancoes_tabela(cancao_id, album_id, cancao, duracao)
VALUES
    (1, 1, 'Soul For Us', 200),
    ...
    (30, 8, "He Hopes We Can't Stay", 120),
...
INSERT INTO SpotifyClone.reproducoes_historico_tabela(usuario_id, cancao_id, data_play)
VALUES
